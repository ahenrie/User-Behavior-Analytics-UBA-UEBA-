...
applications = [
    'None', 'services.exe', 'RuntimeBroker.exe', 'winlogon.exe', 'svchost.exe', 'opera.exe',
    'chrome.exe', 'trojan.exe', 'malware.exe', 'bad.exe', 'data_stealer.exe', 'backdoor.exe'
]

# Define the possible AccountNames
account_names = ['doris', 'Robot', 'ROOT']
